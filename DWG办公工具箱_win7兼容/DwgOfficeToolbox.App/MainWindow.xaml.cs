...
public partial class MainWindow : Window
{
    ...
    private List<DwgScanTarget> BuildScanTargets(List<string> folders, List<string> files, string outputFolderName)
    {
        ...
        foreach (var folder in folders)
        {
            ...
            {
                var rel = GetRelativePath(folder, dwg);
    ...
    private void SettingsButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            _settings.OdaExePath = settingsWindow.Settings.OdaExePath;
            _settings.OutputFolderName = settingsWindow.Settings.OutputFolderName;
            _settings.OutputVersion = settingsWindow.Settings.OutputVersion;
            _settings.OutputFormat = settingsWindow.Settings.OutputFormat;
            _settings.InputFilter = settingsWindow.Settings.InputFilter;
            _settings.MaxConvertConcurrency = settingsWindow.Settings.MaxConvertConcurrency;
            _settings.LargeFileThresholdMB = settingsWindow.Settings.LargeFileThresholdMB;
            _settings.MaxParseConcurrency = settingsWindow.Settings.MaxParseConcurrency;
            _settings.EnableTextCache = settingsWindow.Settings.EnableTextCache;
            _settings.KeepConvertedDxf = settingsWindow.Settings.KeepConvertedDxf;
            _settings.ClearOutputBeforeConvert = settingsWindow.Settings.ClearOutputBeforeConvert;
