...
| 功能 | 说明 | 简单演示 |
| --- | --- | --- |
| 多工作簿提取到一簿 | 将多个文件的所有工作表提取到一个新工作簿，并生成索引表 | 门店A.xlsx + 门店B.xlsx -> 门店A-1月份、门店B-1月份... |
| 多工作簿提取到一表 | 将多个文件数据提取到一个工作表，支持表头/表尾控制 | 两份月报纵向叠加为一张“汇总结果”表 |
| 一簿提取到一表 | 对每个工作簿内部多工作表执行提取合并 | 门店A.xlsx 的 1月份+2月份 -> 全工作簿汇总 |
